// miniprogram/packageD/pages/GD_share_facial_foam/GD_share_facial_foam.js
...
Page({
   ...
   */
  data: {
    facial_foam_name: '', //string
    facial_foam_price: 0, //number
  ...
  get_name(e) {
    var that = this;
    that.setData({
      facial_foam_name: e.detail,
    })
  },
  get_price(e) {
    var that = this;
    that.setData({
      facial_foam_price: e.detail
    })
  },
  ...
  share: function() {
    ...
    var cur_name = that.data.facial_foam_name;
    var cur_price = that.data.facial_foam_price;
    var cur_skintype = that.data.skin_type;
    db.collection('facial_foam').add({
      data: {
        image: url,
        name: cur_name,
        price: cur_price,
